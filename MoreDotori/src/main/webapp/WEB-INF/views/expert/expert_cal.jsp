...
<body class="layout-8">
    ...
    <!-- Full calendar js -->
    <script src="${pageContext.request.contextPath}/plugins/fullcalendar/js/lib/moment.min.js"></script>
    <script src="${pageContext.request.contextPath}/plugins/fullcalendar/js/lib/jquery-ui.min.js"></script>
