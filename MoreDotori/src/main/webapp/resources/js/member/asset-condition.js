  ...
  $.fn.setTab3ChartData = function(nameArr, inArr, outArr){
  ...
  $.fn.setTab4ChartData = function(nameArr, inArr, outArr){
   ...
   $.fn.getTab1ChartData = function(yyyy, mmmm, dddd){
	   $.ajax({
		   ...
		   success : function(data){
			   ...
			   $.fn.setTab3ChartData(nameArr3, inData3, outData3);
			   
			   var nameArr4 = data.dataName4;
			   var inData4 = data.inData4;
			   var outData4 = data.outData4;
			   $.fn.setTab4ChartData(nameArr4, inData4, outData4);
