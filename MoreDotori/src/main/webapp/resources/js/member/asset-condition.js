$(document).ready(function() {
	...
	Highcharts.chart('chart-highchart-combo2', {
		title: {
			text: 'Combination chart'
		},
		xAxis: {
	...
	Highcharts.chart('chart-highchart-combo3', {
		title: {
			text: 'Combination chart'
		},
		xAxis: {
	...
	$(function() {
		var chart2 = am4core.create("am-pie-2", am4charts.PieChart);
		chart2.data = [{
			"country": "Lithuania",
			"litres": 201.9
		}, {
